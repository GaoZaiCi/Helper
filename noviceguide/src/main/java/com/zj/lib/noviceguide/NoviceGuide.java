...
public class NoviceGuide extends FrameLayout {
    ...
    public void show() {
        ...
        if (messageId!=0){
            ((TextView)inflaterView.findViewById(messageId)).setText(message);
        }
    ...
    public static class Builder {
        ...
        public Builder setShowTime(long time){
            noviceGuide.showTime=time;
            return this;
        }

        public Builder setMessage(@IdRes int messageId,String message){
            noviceGuide.messageId=messageId;
            noviceGuide.message=message;
            return this;
        }
        ...
        public Builder setDismissListener(DismissListener listener){
            noviceGuide.dismissListener=listener;
            return this;
        }
