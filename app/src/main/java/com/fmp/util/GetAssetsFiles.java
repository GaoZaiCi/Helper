    ...
    public static void putAssetsToSDCard(Context context, String assetsPath, String sdCardPath) {
        try {
            ...
            if (mString.length == 0) { // 说明assetsPath为空,或者assetsPath是一个文件
                ...
                int bt = 0;
                File file = new File(com.fmp.core.HelperCore.getHelperDirectory(), sdCardPath + File.separator
                ...
                File file = new File(com.fmp.core.HelperCore.getHelperDirectory(), sdCardPath);
                if (!file.exists())
