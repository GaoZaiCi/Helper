...
import com.fmp.permission.rom.HuaweiUtils;
import com.fmp.permission.rom.MeizuUtils;
import com.fmp.permission.rom.MiuiUtils;
import com.fmp.permission.rom.QikuUtils;
import com.fmp.permission.rom.RomUtils;
...
public class FloatPermissionManager {
    ...
    private void showConfirmDialog(Context context, final OnConfirmResult result) {
        ...
        dialog = new AlertDialog.Builder(context, AlertDialog.THEME_HOLO_LIGHT)
                .setCancelable(true)
                .setTitle("提示")
                .setMessage("您的手机没有授予附魔瓶悬浮窗权限，开启后即可使用完整附魔瓶功能")
