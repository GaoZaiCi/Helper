...
#include "mcpe/item/ArmorSlot.h"
#include "mcpe/client/gui/InventoryPane.h"
#include "mcpe/client/gui/IInventoryPaneCallback.h"
...
public:
	...
	InventoryScreen(MinecraftGame&, ClientInstance&,CraftingType, const BlockPos&);
